...
// console.log("A  " ,arr_4);
// console.log(arr_4.slice(1,3));  // creates new array containing elements (only x coordinate inclusive) but original array remains unchanged
// console.log("B  " ,arr_4);
// console.log(arr_4.splice(1,3));   //creates a new array containing elements (both inclusive) and seperates these elements from original array 
// console.log("C  " ,arr_4);
...
let another_complex_to_simple_array=another_complex_array.flat(Infinity) //.flat(x) : x justifies till which level we have to make array normal .
